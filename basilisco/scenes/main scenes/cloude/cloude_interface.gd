...
func end_game():
	if acertos >= 7:
		get_tree().change_scene_to_file("res://scenes/main scenes/cloude/vitoriaClaude.tscn")
	else:
		get_tree().change_scene_to_file("res://scenes/main scenes/cloude/derrotaClaude.tscn")
